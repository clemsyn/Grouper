...
int user_mv_table[MAX_DVFS_FREQS] = {
	800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1250, 1350};
#endif
...
static const int core_millivolts[MAX_DVFS_FREQS] = {
	900, 950, 1000, 1050, 1100, 1150, 1200, 1300, 1350};
...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g", 13, 3, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1280, 1330, 1370, 1400, 1470, 1500, 1500, 1540, 1700, 1800),
	CPU_DVFS("cpu_g", 13, 4, MHZ, 550, 550, 770, 770,  940,  940, 1160, 1240, 1280, 1360, 1390, 1470, 1500, 1520, 1520, 1600, 1800),
...
static struct dvfs core_dvfs_table[] = {
	/* Core voltages (mV):		    900,   950,    1000,   1050,   1100,    1150,    1200,    1300, 1350 */
	...
	CORE_DVFS("emc",    1, 1, KHZ,   102000, 408000, 408000, 408000, 667000,  667000,  667000,  667000,  667000),
	CORE_DVFS("emc",    2, 1, KHZ,   102000, 408000, 408000, 408000, 667000,  667000,  750000,  800000,  900000),
...
/* Core voltages (mV):		           950,   1000,   1050,   1100,   1150,    1200,    1250,    1300,    1350 */
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  446000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  380000,  416000,  446000,  484000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  484000,  520000),
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
#endif
#else
	...
	CORE_DVFS("host1x", 0, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  400000),
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  400000),
	CORE_DVFS("host1x", 2, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  400000),
	CORE_DVFS("host1x", 3, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  400000),
#ifdef CONFIG_GPU_OVERCLOCK
#ifdef CONFIG_GPU_OC_446
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 380000,  380000,  416000,  446000,  446000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 228000, 275000, 332000, 380000,  446000,  484000,  520000,  600000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 380000,  380000,  416000,  446000,  484000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  416000,  484000,  520000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  416000,  416000,  484000,  520000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 228000, 337000, 350000, 480000,  500000,  550000,  600000,  700000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#else
