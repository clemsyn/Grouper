...
static struct dvfs core_dvfs_table[] = {
	/* Core voltages (mV):		    950,   1000,   1050,   1100,   1150,    1175,    1200,    1250,    1350 */
...
/* Core voltages (mV):		           950,   1000,   1050,   1100,   1150,    1200,    1250,    1300,    1350 */
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  520000,  600000),
#endif
#else
	...
	CORE_DVFS("host1x", 0, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  300000),
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  300000),
	CORE_DVFS("host1x", 2, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  300000),
	CORE_DVFS("host1x", 3, 1, KHZ,        1, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  300000),
#ifdef CONFIG_GPU_OVERCLOCK
#ifdef CONFIG_GPU_OC_446
...
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  446000,  484000,  520000,  600000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  446000,  484000,  520000,  600000),
